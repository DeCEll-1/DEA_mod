...
public class DEA_KarabasanReaperModification extends BaseHullMod {
    ...
    public void applyEffectsBeforeShipCreation(ShipAPI.HullSize hullSize, MutableShipStatsAPI stats, String id) {
        stats.getSystemRegenBonus().modifyFlat(id, 0.016f);
        stats.getSystemUsesBonus().modifyFlatAlways(id, -4f, "");
...
////
////
////            ship.setCustomData("_DEA_KarabasanMissileModifier", "reaper");
////        }
//    }
